...
\def \TITLE{Xây dựng phần mềm tối ưu hóa quy trình điểm danh và quản lý học sinh}
\def \AUTHOR{NGUYỄN VĂN HƯNG}
...
\setcounter{tocdepth}{2} % Không chèn subsubsection vào bảng mục lục
...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[C]{\fontsize{10}{12}\selectfont\nouppercase{\leftmark}}
