...
\begin{titlepage}
  ...
  \begin{center}
    ...
    {\textbf{\Large{Xây dựng phần mềm tối ưu hóa quy trình điểm danh và quản lý học sinh}}\\[1cm]
    
      {\textbf{\large{NGUYỄN VĂN HƯNG}}}\\
      {\large{Hung.NV225634@sis.hust.edu.vn}}\\[0.5cm]
      ...
      \begin{table}[H]
        ...
        \resizebox{\textwidth}{!}{%
          \begin{tabular}{ll}
            \multicolumn{1}{c}{\textbf{Giảng viên hướng dẫn:}} & PGS. TS. Nguyễn Phi Lê \hspace{0.5cm} 
            \\[0.5cm]
            \multicolumn{1}{l}{\textbf{Khoa:}}                 & Khoa học Máy tính \hspace{0.5cm}                   \\ [0.5cm]
            \multicolumn{1}{l}{\textbf{Trường:}}               & Trường Công nghệ Thông tin và Truyền thông \hspace{0.5cm} \\ [4.5cm]
