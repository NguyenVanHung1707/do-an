  ...
  \begin{center}
    ...
    {\textbf{\Large{Xây dựng phần mềm tối ưu hóa quy trình điểm danh và quản lý học sinh}}\\[1cm]
      ...
      \begin{table}[H]
        ...
        \resizebox{\textwidth}{!}{%
          \begin{tabular}{ll}
            \multicolumn{1}{c}{\textbf{Giảng viên hướng dẫn:}} & PGS. TS. Nguyễn Phi Lê \hspace{0.5cm} \underline{\hspace{3cm}} \\[0.5cm]
                                                               & \multicolumn{1}{r}{Chữ kí GVHD}                               \\[0.5cm]
            \textbf{Khoa:}                                     & Khoa học Máy tính                                             \\[0.5cm]
            \textbf{Trường:}                                   & Trường Công nghệ Thông tin và Truyền thông                    \\[4cm]
