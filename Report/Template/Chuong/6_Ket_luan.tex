...
\begin{itemize}
    ...
    \item \textbf{Kiểm thử thực tế}: Hệ thống được thử nghiệm trong môi trường giảng đường với $150$ học viên và $10$ giảng viên. Kết quả ghi nhận hệ thống hoạt động ổn định, độ trễ API dưới $150$ ms, độ chính xác điểm danh trên $95\%$ và dữ liệu chuyên cần, điểm số, nhật ký giám sát được hiển thị thống nhất trên các giao diện tra cứu.
\end{itemize}
